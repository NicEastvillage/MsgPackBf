...
{
	static class SerializationTests
	{
		...
		{
			// Various fixuints
			Console.Write("Testing serialization of uint 01 .. ");
		...
		{
			// Various fixuints
			Console.Write("Testing serialization of uint 02 .. ");
		...
		private static void TestInt01()
		{
			...
			Console.Write("Testing serialization of int 01 .. ");
		...
		private static void TestInt02()
		{
			...
			Console.Write("Testing serialization of int 02 .. ");
		...
		{
			Console.Write("Testing serialization of float 01 .. ");
		...
		{
			Console.Write("Testing serialization of float 02 .. ");
		...
		{
			Console.Write("Testing serialization of map 01 .. ");
		...
		{
			// Small arrays
			Console.Write("Testing serialization of array 01 .. ");
		...
		private static void TestArray02()
		{
			...
			Console.Write("Testing serialization of array 02 .. ");
